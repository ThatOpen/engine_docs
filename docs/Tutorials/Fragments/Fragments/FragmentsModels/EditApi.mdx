<div style={{position: "relative"}}><iframe src="https://thatopen.github.io/engine_fragment/examples/FragmentsModels/EditApi"></iframe><button class="full-screen-btn" onClick={() => window.open("https://thatopen.github.io/engine_fragment/examples/FragmentsModels/EditApi")} >Go Full Screen</button></div>

:::info Source
Copying and pasting? We've got you covered! You can find the full source code of this tutorial [here](https://github.com/ThatOpen/engine_fragment/blob/main/packages/fragments/src/FragmentsModels/examples/EditApi/example.ts).
:::
