...
components.tools.add("minimap", map);
components.ui.add(map.uiElement.get("canvas"));
```
:::tip Adding it to the Tools Component and UI
...
Let's keep it up and check out another tutorial! 🎓
  ...
  <iframe src="https://ifcjs.github.io/components/src/navigation/MiniMap/index.html"></iframe>
