<div style={{position: "relative"}}><iframe src="https://thatopen.github.io/engine_components/examples/LengthMeasurement"></iframe><button class="full-screen-btn" onClick={() => window.open("https://thatopen.github.io/engine_components/examples/LengthMeasurement")} >Go Full Screen</button></div>
