:::info Source
Copying and pasting? We've got you covered! You can find the full source code of this tutorial [here](https://github.com/ThatOpen/engine_components/blob/main/packages/core/src/measurement/Utils/example.ts).
:::
...
<iframe src="https://thatopen.github.io/engine_components/examples/Utils"></iframe>