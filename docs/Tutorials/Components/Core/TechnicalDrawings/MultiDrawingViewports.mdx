<div style={{position: "relative"}}><iframe src="https://thatopen.github.io/engine_components/examples/TechnicalDrawings/MultiDrawingViewports"></iframe><button class="full-screen-btn" onClick={() => window.open("https://thatopen.github.io/engine_components/examples/TechnicalDrawings/MultiDrawingViewports")} >Go Full Screen</button></div>

:::info Source
Copying and pasting? We've got you covered! You can find the full source code of this tutorial [here](https://github.com/ThatOpen/engine_components/blob/main/packages/core/src/drawings/TechnicalDrawings/examples/MultiDrawingViewports/example.ts).
:::
